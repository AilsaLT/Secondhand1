 ...
 * 类描述：
 * 创建人：Liting
 * 创建时间：2019/1/17 16:15
 * 修改人：Liting
 * 修改时间：2019/1/17 16:15
 * 修改备注：
 * 版本：
 */
...
public class CustomHelper {
    ...
    public void onClick(String type, TakePhoto takePhoto) {
        File file = new File(Environment.getExternalStorageDirectory(), "/temp/" + System.currentTimeMillis() + ".jpg");        if (!file.getParentFile().exists()) {
