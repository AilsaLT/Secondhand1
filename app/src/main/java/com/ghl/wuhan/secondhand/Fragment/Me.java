...
import com.ghl.wuhan.secondhand.me_activity.user_query;
...
private ImageView iv_deng;
    ...
    private RelativeLayout rl_deng,rl_deng1,rl_set;
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        rl_set=getActivity().findViewById(R.id.rl_set);
        ...
        rl_set.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(getActivity(),user_query.class);
                startActivity(intent);
            }
        });
